...
namespace Leap.Unity.Examples
{
    ...
    public class TurntableVisuals : MonoBehaviour
    {
        ...
        private int _circleSegments = 36;
        ...
        private PokeRotation _turntable;
        ...
        {
            _turntable = GetComponent<PokeRotation>();
        }
        ...
        public void UpdateVisuals()
        {
            ...
            anchor.localPosition = new Vector3(0, height + 0.1f, 0);
            ...
            Vector3 DashScale =
                Vector3.one * dashDirection.magnitude / DASH_MESH_LENGTH * (1f - _heightOffset);
        ...
        {
            if (_dashMesh == null || _dashMaterial == null || _dashMatrices == null)
                return;
        ...
        private void DecomposeTRSMatrix(
            Matrix4x4 m,
